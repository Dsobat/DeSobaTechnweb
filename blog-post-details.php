...
<head>
     ...
     <title>DeSoba Technologies | Post Details</title>
...
<hr />
                         <h4>Recent DeSoba Technologies Activities</h4>
<hr />
                         <ul class="list">
<?php
...
?>
                         ...
                         <h4 style="color: #0000FF;">Leave a request for your information technology needs</h4>
    ...
    <input type="hidden" name="csrftoken" value="<?php echo htmlentities($_SESSION['token']); ?>" />
                              ...
                              <div class="form-group">
                                   ...
                                   <textarea name="request" class="form-control" rows="10" autocomplete="off" required></textarea>
                              </div>
